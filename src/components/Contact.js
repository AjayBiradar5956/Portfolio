    ...
    return (
        <div name='Contact' className='w-full md:h-screen mb-5 pt-[100px]'>
            <div className=' max-w-[1000px] h-[100%] mx-auto flex-col flex justify-center items-center'>
                <h1 className='mb-10 font-bold text-4xl text-[#0a192F] border-b-4 border-pink-600 self-center'>Get In Touch</h1>
                <div className='flex md:flex-row pt-4 flex-col justify-around items-center w-full h-[70%] '>
                    ...
                    <div className=' h-[400px] w-[450px] rounded-lg bg-[#F8E5E5]'>
                        ...
                        <form action='https://getform.io/f/f2ce87bd-efe8-4ba4-946f-e42a9b96c9f7' method='post' className='flex flex-col justify-center p-5'>
                            <input
                                ...
                                className='border-b-2 border-[#000000] p-1 bg-inherit' />
                            <br></br>
                            <input
                                type='email'
                                name='email'
                                className='border-b-2 border-black p-1 bg-inherit'
                            ...
                            <textarea
                                ...
                                className='border-b-2 p-1 border-black bg-inherit'>
                            </textarea>
                            <button
