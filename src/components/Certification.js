    ...
    return (
        <div name="Certification" className=' w-full h-auto bg-[#317773] flex text-black flex-col justify-center items-center'>
            ...
            <div className=' h-[500px] pb-10 w-[75%] flex flex-wrap justify-evenly pt-5'>
                ...
                <div className=' h-[45%] w-[30%]'>
                    <a
                        href='https://drive.google.com/file/d/1fG0hBVXPtUf4MxVXjWzWl5a-uY--DbBE/view?usp=sharing'
                    ...
                    >
                        <img
                            ...
                            className='h-full w-full object-contain hover:scale-110 duration-300 cursor-pointer'
                        />
                    </a>
                </div>
                <div className=' h-[45%] w-[30%]'>
                    <a
                        href='https://drive.google.com/file/d/18OYPwwcQZ53U60FWhdWFis_w96FYIBU2/view?usp=sharing'
                        rel="noopener noreferrer"
                        target="_blank"
                    >
                        <img
