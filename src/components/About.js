...
const About = () => {
    return (
        <div
            name='About'
            className='w-full md:h-screen pt-4 sm:h-auto bg-[#2c8e70] text-gray-300'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div
                    className='max-w-[1200px] w-full grid sm:grid-cols-2 mb-[180px] sm:mb-0 gap-8 px-4'>
                    <div className='sm:text-right text-3xl font-bold '>
                        <p>
                            Hi. I'm Ajay Biradar, 2020 Graduate from Vidya Jyothi Institute of Technology, Hyderabad CGPA: 9.16
                        </p>
                    </div>
